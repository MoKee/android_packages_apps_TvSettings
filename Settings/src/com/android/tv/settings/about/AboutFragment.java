...
public class AboutFragment extends SettingsPreferenceFragment {
    ...
    private static final String PROPERTY_MOKEEE_VERSION = "ro.mk.version";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        findPreference(KEY_MOKEE_VERSION)
                .setSummary(getSystemPropertySummary(PROPERTY_MOKEE_VERSION));
        ...
        switch (preference.getKey()) {
            ...
            case KEY_MOKEE_VERSION:
                ...
                if (mHits[0] >= (SystemClock.uptimeMillis() - 500)) {
                    ...
                    intent.putExtra("is_mokee", preference.getKey().equals(KEY_MOKEE_VERSION));
